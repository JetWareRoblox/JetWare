game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Loaded", Text = "Loaded!"})
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Made By", Text = "Made By Jet#7109"})
